...
public static class CurrencyEndpoint
{
    ...
    static async Task<Results<Ok<decimal>,BadRequest>> Update([FromRoute]string id, decimal amount,[FromServices]ICurrencyRepository currencyRepository, CancellationToken cancellationToken = default)
    {
